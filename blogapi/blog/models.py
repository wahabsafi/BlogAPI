...
class Article(BaseModel):
    ...
    status = models.CharField(
        _("status"), max_length=1, choices=status_choices, default=REVIWING
    )
    ...
    def category_to_str(self):
        """returns all the category names in category list"""
        return ",".join([category.title for category in self.category])
